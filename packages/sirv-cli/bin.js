...
sade('sirv [dir]')
	...
	.option('-S, --https', 'Enable the HTTPS protocol')
	.option('-k, --http2', 'Enable the HTTP/2 protocol. Requires Node.js 8.4.0+')
	.option('-C, --cert', 'Path to certificate file for HTTPS and HTTP/2 servers')
	.option('-K, --key', 'Path to certificate key for HTTPS and HTTP/2 servers')
